  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = plansys2_msgs::action::ExecutePlan_Goal;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs::action::ExecutePlan_Result;
    is_plain =
      (
...
// forward declaration of message dependencies and their conversion functions
// functions for plansys2_msgs::msg::ActionExecutionInfo already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs::action::ExecutePlan_Feedback;
    is_plain =
      (
      offsetof(DataType, action_execution_status) +
      last_member_size
...
// functions for plansys2_msgs::action::ExecutePlan_Goal already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs::action::ExecutePlan_SendGoal_Request;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs::action::ExecutePlan_SendGoal_Response;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs::action::ExecutePlan_GetResult_Request;
    is_plain =
      (
...
// forward declaration of message dependencies and their conversion functions
// functions for plansys2_msgs::action::ExecutePlan_Result already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs::action::ExecutePlan_GetResult_Response;
    is_plain =
      (
...
// functions for plansys2_msgs::action::ExecutePlan_Feedback already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs::action::ExecutePlan_FeedbackMessage;
    is_plain =
      (
