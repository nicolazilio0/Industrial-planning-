...
#include "plansys2_msgs/msg/detail/action__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const plansys2_msgs::msg::Action & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  plansys2_msgs::msg::Action & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = plansys2_msgs::msg::Action;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const plansys2_msgs::msg::Action *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<plansys2_msgs::msg::Action *>(
    untyped_ros_message);
...
{
  return &plansys2_msgs::msg::typesupport_fastrtps_cpp::_Action__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, plansys2_msgs, msg, Action)() {
  return &plansys2_msgs::msg::typesupport_fastrtps_cpp::_Action__handle;
}
