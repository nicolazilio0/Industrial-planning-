...
class Action(metaclass=Metaclass_Action):
    ...
    _fields_and_field_types = {
        ...
        'preconditions': 'plansys2_msgs/Tree',
        'effects': 'plansys2_msgs/Tree',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from plansys2_msgs.msg import Tree
        self.preconditions = kwargs.get('preconditions', Tree())
        from plansys2_msgs.msg import Tree
        self.effects = kwargs.get('effects', Tree())
    ...
    def preconditions(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'preconditions' field must be a sub message of type 'Tree'"
        self._preconditions = value

    @builtins.property
    def effects(self):
        """Message field 'effects'."""
    ...
    def effects(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Tree), \
                "The 'effects' field must be a sub message of type 'Tree'"
        self._effects = value
