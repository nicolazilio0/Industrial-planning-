...
void fetch_function__ActionPerformerStatus__specialized_arguments(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__ActionPerformerStatus__specialized_arguments(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__ActionPerformerStatus__specialized_arguments(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__ActionPerformerStatus__specialized_arguments(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ActionPerformerStatus_message_member_array[5] = {
  {
    "status_stamp",  // name
    ...
    offsetof(plansys2_msgs::msg::ActionPerformerStatus, status_stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    fetch_function__ActionPerformerStatus__specialized_arguments,  // fetch(index, &value) function pointer
    assign_function__ActionPerformerStatus__specialized_arguments,  // assign(index, value) function pointer
