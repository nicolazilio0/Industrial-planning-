...
void fetch_function__DurativeAction__parameters(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const plansys2_msgs::msg::Param *>(
    get_const_function__DurativeAction__parameters(untyped_member, index));
  auto & value = *reinterpret_cast<plansys2_msgs::msg::Param *>(untyped_value);
  value = item;
}

void assign_function__DurativeAction__parameters(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<plansys2_msgs::msg::Param *>(
    get_function__DurativeAction__parameters(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DurativeAction_message_member_array[7] = {
  ...
  },
  {
    ...
    fetch_function__DurativeAction__parameters,  // fetch(index, &value) function pointer
    assign_function__DurativeAction__parameters,  // assign(index, value) function pointer
