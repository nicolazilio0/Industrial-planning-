...
static const _GetOrderedSubGoals_Request_type_support_symbol_names_t _GetOrderedSubGoals_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plansys2_msgs, srv, GetOrderedSubGoals_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plansys2_msgs, srv, GetOrderedSubGoals_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plansys2_msgs, srv, GetOrderedSubGoals_Request)() {
  return &::plansys2_msgs::srv::rosidl_typesupport_c::GetOrderedSubGoals_Request_message_type_support_handle;
}
...
static const _GetOrderedSubGoals_Response_type_support_symbol_names_t _GetOrderedSubGoals_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plansys2_msgs, srv, GetOrderedSubGoals_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plansys2_msgs, srv, GetOrderedSubGoals_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plansys2_msgs, srv, GetOrderedSubGoals_Response)() {
  return &::plansys2_msgs::srv::rosidl_typesupport_c::GetOrderedSubGoals_Response_message_type_support_handle;
}
...
static const _GetOrderedSubGoals_type_support_symbol_names_t _GetOrderedSubGoals_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plansys2_msgs, srv, GetOrderedSubGoals)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plansys2_msgs, srv, GetOrderedSubGoals)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, plansys2_msgs, srv, GetOrderedSubGoals)() {
  return &::plansys2_msgs::srv::rosidl_typesupport_c::GetOrderedSubGoals_service_type_support_handle;
}
