...
static const _GetNodeDetails_Request_type_support_symbol_names_t _GetNodeDetails_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plansys2_msgs, srv, GetNodeDetails_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plansys2_msgs, srv, GetNodeDetails_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plansys2_msgs, srv, GetNodeDetails_Request)() {
  return &::plansys2_msgs::srv::rosidl_typesupport_c::GetNodeDetails_Request_message_type_support_handle;
}
...
static const _GetNodeDetails_Response_type_support_symbol_names_t _GetNodeDetails_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plansys2_msgs, srv, GetNodeDetails_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plansys2_msgs, srv, GetNodeDetails_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plansys2_msgs, srv, GetNodeDetails_Response)() {
  return &::plansys2_msgs::srv::rosidl_typesupport_c::GetNodeDetails_Response_message_type_support_handle;
}
...
static const _GetNodeDetails_type_support_symbol_names_t _GetNodeDetails_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plansys2_msgs, srv, GetNodeDetails)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plansys2_msgs, srv, GetNodeDetails)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, plansys2_msgs, srv, GetNodeDetails)() {
  return &::plansys2_msgs::srv::rosidl_typesupport_c::GetNodeDetails_service_type_support_handle;
}
