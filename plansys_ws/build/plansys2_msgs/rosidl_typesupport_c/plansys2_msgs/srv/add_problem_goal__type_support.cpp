...
static const _AddProblemGoal_Request_type_support_symbol_names_t _AddProblemGoal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plansys2_msgs, srv, AddProblemGoal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plansys2_msgs, srv, AddProblemGoal_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plansys2_msgs, srv, AddProblemGoal_Request)() {
  return &::plansys2_msgs::srv::rosidl_typesupport_c::AddProblemGoal_Request_message_type_support_handle;
}
...
static const _AddProblemGoal_Response_type_support_symbol_names_t _AddProblemGoal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plansys2_msgs, srv, AddProblemGoal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plansys2_msgs, srv, AddProblemGoal_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plansys2_msgs, srv, AddProblemGoal_Response)() {
  return &::plansys2_msgs::srv::rosidl_typesupport_c::AddProblemGoal_Response_message_type_support_handle;
}
...
static const _AddProblemGoal_type_support_symbol_names_t _AddProblemGoal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plansys2_msgs, srv, AddProblemGoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plansys2_msgs, srv, AddProblemGoal)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, plansys2_msgs, srv, AddProblemGoal)() {
  return &::plansys2_msgs::srv::rosidl_typesupport_c::AddProblemGoal_service_type_support_handle;
}
