  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = plansys2_msgs__srv__GetDomainActionDetails_Request;
    is_plain =
      (
...
static size_t _GetDomainActionDetails_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_plansys2_msgs__srv__GetDomainActionDetails_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs__srv__GetDomainActionDetails_Response;
    is_plain =
      (
...
static size_t _GetDomainActionDetails_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_plansys2_msgs__srv__GetDomainActionDetails_Response(
    full_bounded, is_plain, 0);
