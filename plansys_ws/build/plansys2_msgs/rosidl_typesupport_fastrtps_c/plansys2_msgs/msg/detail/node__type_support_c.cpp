...
#include "plansys2_msgs/msg/detail/node__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // children
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // children
...
using _Node__ros_msg_type = plansys2_msgs__msg__Node;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: expression_type
  {
    cdr << ros_message->expression_type;
  }

  // Field name: modifier_type
  {
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: children
  {
    ...
    if (ros_message->children.data) {
      rosidl_runtime_c__uint32__Sequence__fini(&ros_message->children);
    }
...
static uint32_t _Node__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_plansys2_msgs__msg__Node(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = plansys2_msgs__msg__Node;
    is_plain =
      (
...
static size_t _Node__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_plansys2_msgs__msg__Node(
