...
#include "plansys2_msgs/msg/detail/param__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // name, sub_types, type
#include "rosidl_runtime_c/string_functions.h"  // name, sub_types, type

// forward declare type support functions


using _Param__ros_msg_type = plansys2_msgs__msg__Param;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: sub_types
  {
    ...
    auto array_ptr = ros_message->sub_types.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: sub_types
  {
    ...
    if (ros_message->sub_types.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->sub_types);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->sub_types, size)) {
      fprintf(stderr, "failed to create array for field 'sub_types'");
      return false;
    }
    auto array_ptr = ros_message->sub_types.data;
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'sub_types'\n");
        return false;
      }
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name sub_types
  {
    size_t array_size = ros_message->sub_types.size;
    auto array_ptr = ros_message->sub_types.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
...
static uint32_t _Param__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_plansys2_msgs__msg__Param(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = plansys2_msgs__msg__Param;
    is_plain =
      (
      offsetof(DataType, sub_types) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Param__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_plansys2_msgs__msg__Param(
