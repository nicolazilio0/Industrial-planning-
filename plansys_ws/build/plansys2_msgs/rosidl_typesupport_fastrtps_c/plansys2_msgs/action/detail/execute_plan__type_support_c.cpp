  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = plansys2_msgs__action__ExecutePlan_Goal;
    is_plain =
      (
...
static size_t _ExecutePlan_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_plansys2_msgs__action__ExecutePlan_Goal(
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: action_execution_status
  {
    ...
    if (!plansys2_msgs__msg__ActionExecutionInfo__Sequence__init(&ros_message->action_execution_status, size)) {
      fprintf(stderr, "failed to create array for field 'action_execution_status'");
      return false;
    }
    auto array_ptr = ros_message->action_execution_status.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs__action__ExecutePlan_Result;
    is_plain =
      (
      offsetof(DataType, action_execution_status) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ExecutePlan_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_plansys2_msgs__action__ExecutePlan_Result(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs__action__ExecutePlan_Feedback;
    is_plain =
      (
      offsetof(DataType, action_execution_status) +
      last_member_size
...
static size_t _ExecutePlan_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_plansys2_msgs__action__ExecutePlan_Feedback(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs__action__ExecutePlan_SendGoal_Request;
    is_plain =
      (
...
static size_t _ExecutePlan_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_plansys2_msgs__action__ExecutePlan_SendGoal_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs__action__ExecutePlan_SendGoal_Response;
    is_plain =
      (
...
static size_t _ExecutePlan_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_plansys2_msgs__action__ExecutePlan_SendGoal_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs__action__ExecutePlan_GetResult_Request;
    is_plain =
      (
...
static size_t _ExecutePlan_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_plansys2_msgs__action__ExecutePlan_GetResult_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs__action__ExecutePlan_GetResult_Response;
    is_plain =
      (
...
static size_t _ExecutePlan_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_plansys2_msgs__action__ExecutePlan_GetResult_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = plansys2_msgs__action__ExecutePlan_FeedbackMessage;
    is_plain =
      (
...
static size_t _ExecutePlan_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_plansys2_msgs__action__ExecutePlan_FeedbackMessage(
    full_bounded, is_plain, 0);
