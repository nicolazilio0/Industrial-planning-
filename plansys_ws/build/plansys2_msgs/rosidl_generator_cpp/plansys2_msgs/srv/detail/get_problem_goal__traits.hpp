...
inline void to_flow_style_yaml(
  const GetProblemGoal_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: request
...
inline std::string to_yaml(const GetProblemGoal_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const plansys2_msgs::srv::GetProblemGoal_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const plansys2_msgs::srv::GetProblemGoal_Request & msg)
{
...
inline void to_flow_style_yaml(
  const GetProblemGoal_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: success
...
inline std::string to_yaml(const GetProblemGoal_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use plansys2_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const plansys2_msgs::srv::GetProblemGoal_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  plansys2_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use plansys2_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const plansys2_msgs::srv::GetProblemGoal_Response & msg)
{
  return plansys2_msgs::srv::to_yaml(msg);
}
