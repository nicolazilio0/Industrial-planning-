...
: ${AMENT_CURRENT_PREFIX:="/root/plansys_ws/install/plansys2_bt_example"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/plansys2_bt_example/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/plansys2_bt_example/environment/path.sh"
