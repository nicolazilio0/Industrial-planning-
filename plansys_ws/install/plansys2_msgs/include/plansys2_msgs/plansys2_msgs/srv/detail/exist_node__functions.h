...
#ifndef PLANSYS2_MSGS__SRV__DETAIL__EXIST_NODE__FUNCTIONS_H_
#define PLANSYS2_MSGS__SRV__DETAIL__EXIST_NODE__FUNCTIONS_H_
...
/// Initialize srv/ExistNode message.
/**
...
/// Finalize srv/ExistNode message.
/**
...
/// Create srv/ExistNode message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * plansys2_msgs__srv__ExistNode_Request__init().
...
/// Destroy srv/ExistNode message.
/**
 * It calls
 * plansys2_msgs__srv__ExistNode_Request__fini()
...
/// Check for srv/ExistNode message equality.
/**
...
/// Initialize array of srv/ExistNode messages.
/**
...
/// Finalize array of srv/ExistNode messages.
/**
 * It calls
 * plansys2_msgs__srv__ExistNode_Request__fini()
...
/// Create array of srv/ExistNode messages.
/**
 * It allocates the memory for the array and calls
 * plansys2_msgs__srv__ExistNode_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ExistNode messages.
/**
 * It calls
 * plansys2_msgs__srv__ExistNode_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ExistNode message array equality.
/**
...
/// Copy an array of srv/ExistNode messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * plansys2_msgs__srv__ExistNode_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_plansys2_msgs
...
/**
 * It calls
 * plansys2_msgs__srv__ExistNode_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_plansys2_msgs
...
/**
 * It allocates the memory for the array and calls
 * plansys2_msgs__srv__ExistNode_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_plansys2_msgs
...
/**
 * It calls
 * plansys2_msgs__srv__ExistNode_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PLANSYS2_MSGS__SRV__DETAIL__EXIST_NODE__FUNCTIONS_H_
