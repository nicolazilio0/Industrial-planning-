...
#ifndef PLANSYS2_MSGS__SRV__DETAIL__GET_PLAN__FUNCTIONS_H_
#define PLANSYS2_MSGS__SRV__DETAIL__GET_PLAN__FUNCTIONS_H_
 ...
 * calls
 * plansys2_msgs__srv__GetPlan_Request__init().
...
/**
 * It calls
 * plansys2_msgs__srv__GetPlan_Request__fini()
 ...
 * plansys2_msgs__srv__GetPlan_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * plansys2_msgs__srv__GetPlan_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * plansys2_msgs__srv__GetPlan_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_plansys2_msgs
...
/**
 * It calls
 * plansys2_msgs__srv__GetPlan_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_plansys2_msgs
...
/**
 * It allocates the memory for the array and calls
 * plansys2_msgs__srv__GetPlan_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_plansys2_msgs
...
/**
 * It calls
 * plansys2_msgs__srv__GetPlan_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PLANSYS2_MSGS__SRV__DETAIL__GET_PLAN__FUNCTIONS_H_
