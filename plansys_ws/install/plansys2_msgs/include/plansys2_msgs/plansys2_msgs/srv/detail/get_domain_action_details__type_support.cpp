...
void fetch_function__GetDomainActionDetails_Request__parameters(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__GetDomainActionDetails_Request__parameters(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__GetDomainActionDetails_Request__parameters(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__GetDomainActionDetails_Request__parameters(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetDomainActionDetails_Request_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__GetDomainActionDetails_Request__parameters,  // fetch(index, &value) function pointer
    assign_function__GetDomainActionDetails_Request__parameters,  // assign(index, value) function pointer
