...
{
  new (message_memory) plansys2_msgs::msg::Tree(_init);
}

void Tree_fini_function(void * message_memory)
{
  auto typed_message = static_cast<plansys2_msgs::msg::Tree *>(message_memory);
  typed_message->~Tree();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Tree_message_member_array[1] = {
  {
    "nodes",  // name
    ...
    offsetof(plansys2_msgs::msg::Tree, nodes),  // bytes offset in struct
...
{
  return &::plansys2_msgs::msg::rosidl_typesupport_introspection_cpp::Tree_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, plansys2_msgs, msg, Tree)() {
  return &::plansys2_msgs::msg::rosidl_typesupport_introspection_cpp::Tree_message_type_support_handle;
}
