...
bool plansys2_msgs__srv__get_plan__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("plansys2_msgs.srv._get_plan.GetPlan_Request", full_classname_dest, 43) == 0);
  }
  plansys2_msgs__srv__GetPlan_Request * ros_message = _ros_message;
  {  // domain
...
PyObject * plansys2_msgs__srv__get_plan__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("plansys2_msgs.srv._get_plan");
...
ROSIDL_GENERATOR_C_EXPORT
bool plansys2_msgs__srv__get_plan__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("plansys2_msgs.srv._get_plan.GetPlan_Response", full_classname_dest, 44) == 0);
  }
  plansys2_msgs__srv__GetPlan_Response * ros_message = _ros_message;
  {  // success
