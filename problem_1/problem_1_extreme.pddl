(define (problem problem_1_extreme) (:domain assignment_problem_1)
(:objects 
...
(:init
    ...
    (atr robot1 centralwarehouse)
    (atr robot2 centralwarehouse)
    (atr robot3 centralwarehouse)
    (atr robot4 centralwarehouse)
    (atr robot5 centralwarehouse)
    (atr robot6 centralwarehouse)
    (atr robot7 centralwarehouse)
