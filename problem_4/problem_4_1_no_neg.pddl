(define (problem problem_4_no_neg) (:domain assignment_problem_4_no_neg)
(:objects 
    agv1 - agv
    drone1 - drone
...
(:init
    ...
    ; define robot capacity
    (capacity drone1 s0)

    ; define state of locations
    (free l1)
    (free l2)
    (free l3)
    (free l4)
    ...
    ; define the relationships between nubers
